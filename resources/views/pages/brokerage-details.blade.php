...
<div class="bg-white min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 pt-28 pb-20">
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <!-- LEFT SIDE: Gallery, Specs, Map & Description -->
            <div class="w-full lg:w-2/3">
                ...
                <div class="mb-16" data-aos="fade-up">
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <h3 class="serif text-lg font-black uppercase tracking-[0.3em]">Quick Specifications</h3>
                    </div>
                ...
                <div class="mb-16" data-aos="fade-up">
                    <div class="flex items-center gap-4 mb-8">
                        <div class="h-[2px] w-12 bg-[#f4a41c]"></div>
                        <h3 class="serif text-lg font-black uppercase tracking-[0.3em]">Location <span class="text-[#f4a41c]">Map</span></h3>
                    </div>
                ...
                <div class="border-t border-gray-100 pt-16" data-aos="fade-up">
                    <h3 class="serif text-2xl font-black mb-8 uppercase tracking-widest">Description</h3>
            ...
            <div class="w-full lg:w-1/3">
                <div class="lg:sticky lg:top-32 space-y-8">
                    ...
                    <div class="bg-white shadow-2xl border border-gray-100 rounded-sm overflow-hidden" data-aos="fade-left" data-aos-delay="100">
                        <div class="bg-gray-50 px-10 py-8 border-b border-gray-100">
                            <h3 class="text-gray-900 text-xs font-black uppercase tracking-[0.4em]">Schedule an Appointment</h3>
                        </div>
                        <div class="p-10">
                            <form action="{{ route('contact.send') }}" method="POST" class="space-y-8">
                                ...
                                <div class="relative">
                                    <input type="text" name="name" required placeholder=" " class="peer w-full bg-transparent border-b-2 border-gray-100 py-3 text-sm font-bold focus:outline-none focus:border-[#f4a41c] transition-all">
                                    <label class="absolute left-0 top-3 text-[10px] font-black text-gray-400 uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-[#f4a41c] peer-[:not(:placeholder-shown)]:-top-4">Full Name</label>
                                </div>
                                <div class="relative">
                                    <input type="email" name="email" required placeholder=" " class="peer w-full bg-transparent border-b-2 border-gray-100 py-3 text-sm font-bold focus:outline-none focus:border-[#f4a41c] transition-all">
                                    <label class="absolute left-0 top-3 text-[10px] font-black text-gray-400 uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-[#f4a41c] peer-[:not(:placeholder-shown)]:-top-4">Email Address</label>
                                </div>
                                <div class="relative">
                                    <input type="text" name="phone" required placeholder=" " class="peer w-full bg-transparent border-b-2 border-gray-100 py-3 text-sm font-bold focus:outline-none focus:border-[#f4a41c] transition-all">
                                    <label class="absolute left-0 top-3 text-[10px] font-black text-gray-400 uppercase tracking-widest transition-all peer-focus:-top-4 peer-focus:text-[#f4a41c] peer-[:not(:placeholder-shown)]:-top-4">Phone Number</label>
                                </div>
                                <div class="relative">
                                    <textarea name="message" rows="3" placeholder=" " class="peer w-full bg-transparent border-b-2 border-gray-100 py-3 text-sm font-bold focus:outline-none focus:border-[#f4a41c] resize-none transition-all"></textarea>
                                ...
                                <button type="submit" class="w-full bg-[#f4a41c] text-white py-6 font-black uppercase text-[11px] tracking-[0.5em] hover:bg-black transition-all shadow-xl hover:-translate-y-1 active:translate-y-0">
                                    Send Inquiry
                                </button>
                            </form>
                        </div>
                    ...
                    <!-- RELATED -->
                    <div class="bg-gray-50 p-10 border border-gray-100 rounded-sm" data-aos="fade-left" data-aos-delay="200">
                        <h4 class="serif text-[11px] font-black uppercase mb-10 border-b border-gray-200 pb-5 flex justify-between items-center">Similar Options <span class="w-10 h-[2px] bg-[#f4a41c]"></span></h4>
                        <div class="space-y-8">
                            ...
                            <a href="{{ route('brokerage.show', $rel->slug) }}" class="flex gap-5 group items-center">
                                ...
                                <div>
                                    <h5 class="text-[10px] font-black uppercase leading-tight group-hover:text-[#f4a41c] transition-colors line-clamp-2">{{ $rel->title }}</h5>
                                    <p class="text-gray-400 text-[11px] font-black mt-2 italic">৳ {{ $rel->price }}</p>
                                </div>
                            </a>
                            @endforeach
                        </div>
