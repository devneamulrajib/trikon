...
<section class="bg-gray-50 min-h-screen pb-32">
    <!-- PREMIUM HERO HEADER -->
    <div class="relative py-32 md:py-40 bg-black overflow-hidden border-b-4 border-[#f4a41c]">
        <div class="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center pt-10">
            <h4 class="text-[#f4a41c] text-xs font-black uppercase tracking-[0.8em] mb-6" data-aos="fade-down">Find Your Perfection</h4>
    ...
    <div class="max-w-7xl mx-auto px-6 -mt-12 relative z-20">
        ...
        <div class="flex flex-wrap justify-center gap-4 mb-24" id="filter-tabs">
            ...
            <button onclick="filterList('Land', this)" class="filter-btn px-14 py-5 text-[12px] font-black uppercase tracking-[0.3em] bg-white text-black shadow-2xl border-2 border-white hover:border-[#f4a41c] transition-all duration-300 rounded-sm">
                Land / Plots
            </button>
            <button onclick="filterList('Flat', this)" class="filter-btn px-14 py-5 text-[12px] font-black uppercase tracking-[0.3em] bg-white text-black shadow-2xl border-2 border-white hover:border-[#f4a41c] transition-all duration-300 rounded-sm">
                Flats / Apartments
            </button>
        </div>
                ...
                <a href="{{ route('brokerage.show', $item->slug) }}" class="block">
                    ...
                    <div class="h-[350px] overflow-hidden relative">
                        ...
                        <div class="absolute top-8 left-8 flex flex-col gap-3">
                            ...
                            <span class="bg-black text-white text-[9px] px-5 py-2 font-bold uppercase tracking-widest">
                        ...
                        <div class="flex items-center justify-between py-8 my-8 border-y border-gray-100">
                            @if($item->category === 'Flat')
                                <div class="flex flex-col items-center">
                                    ...
                                    <span class="text-[9px] font-black uppercase text-gray-400">{{ $item->bedrooms ?? '0' }} Beds</span>
                                </div>
                                <div class="flex flex-col items-center">
                                    <i class="fa-solid fa-bath text-[#f4a41c] text-sm mb-2"></i>
                                    <span class="text-[9px] font-black uppercase text-gray-400">{{ $item->bathrooms ?? '0' }} Baths</span>
                                </div>
                                <div class="flex flex-col items-center">
                                    <i class="fa-solid fa-maximize text-[#f4a41c] text-sm mb-2"></i>
                                    <span class="text-[9px] font-black uppercase text-gray-400">{{ $item->area_sqft ?? '0' }} sft</span>
                                </div>
                            @else
                                ...
                                <div class="flex flex-col items-end">
                                    <span class="text-[9px] font-black uppercase text-[#f4a41c] tracking-widest mb-1">Block</span>
